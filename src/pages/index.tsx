            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:col-gap-16 lg:col-gap-32 row-gap-0 md:row-gap-32">
              <div className="p-6">
                ...
                <div className="lg:mt-10 lg:mb-10 flex flex-col lg:flex-row">
                  ...
                  <a href="#" role="button" className="w-full mb-4 text-center border-2 border-blue-light hover:border-white hover:text-white text-sm text-blue-light uppercase font-bold py-4 px-6 rounded-md">
                    Read the Whitepaper
                  </a>
                </div>
              </div>
