...
const Navigation = () => {
  ...
  return (
    <nav className={ navbar 
      ? "bg-blue-light bg-opacity-75 sticky top-0 z-50 backdrop-filter firefox:bg-opacity-95 transition easy-in-out duration-200"
      : "bg-blue-light lg:bg-transparent sticky top-0 z-50 transition easy-in-out duration-200"
      }>
      <div className="flex flex-wrap container px-5 p-2 lg:p-6 mx-auto flex items-center justify-between">
        <div className="flex items-center flex-shrink-0 text-white lg:mr-8 lg:pr-8 lg:px-6 lg:border-r">
